  ...
  public:
    ...
    struct clause_part
    {
      ...
      enum kind_type
      {
        ...
        kind_param_val, // model points to query_param while native_info points
        kind_param_ref, // to the native_column_info array.

        kind_native,    // model is the index in the strings vector.
        ...
        // Operators.
        //
        // For binary operators, model is the index of the last element
        ...
        op_in,          // in(), model is the number of arguments
