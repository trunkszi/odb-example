...
namespace odb
{
  namespace mssql
  {
    ...
    private:
      ...
      // Custom implementation for SQL Server that also moves long model
      // columns to the end.
      //
      static void
    ...
    public:
      ...
      // While the long model columns can appear in any order in the
      ...
      // Return true if any long model was streamed.
      //
      bool
    ...
    private:
      ...
      SQLUSMALLINT long_count_;   // Number of long model columns.
