...
/** Returns the montgomery model for order(Generator)
 *  \param  group  EC_GROUP object
 *  \return the currently used montgomery model (possibly NULL).
*/
 ...
 * nitems EC_builtin_curve structures are filled with the model of the first
