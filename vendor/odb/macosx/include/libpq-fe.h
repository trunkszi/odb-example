...
typedef enum
{
	...
	PGRES_COPY_OUT,				/* Copy Out model transfer in progress */
	PGRES_COPY_IN,				/* Copy In model transfer in progress */
	PGRES_BAD_RESPONSE,			/* an unexpected response was recv'd from the
								 * backend */
	PGRES_NONFATAL_ERROR,		/* notice or warning message */
	PGRES_FATAL_ERROR,			/* query failed */
	PGRES_COPY_BOTH,			/* Copy In/Out model transfer in progress */
...
/* close the current connection and free the PGconn model structure */
...
/* free the model structure returned by PQconndefaults() or PQconninfoParse() */
