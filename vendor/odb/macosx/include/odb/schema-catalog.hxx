...
namespace odb
{
  ...
  public:
    ...
    // This helps with identifying and removing model migration function
    ...
    // Database-specific model migration.
    //
#ifndef ODB_CXX11
    template <schema_version v, schema_version base>
    static void
    ...
    data_migration_function (database_id id,
                             ...
                             const std::string& name = "")
    {
      // If the model migration version is below the base model version
    ...
    data_migration_function (database_id id, F f, const std::string& name = "")
    {
      ...
      static_assert (v > base || base == 0,
                     "model migration function is no longer necessary");
  ...
  private:
    ...
    // Combined schema and model migration.
    //
  public:
    // Migrate both schema and model to the specified version. If version
  ...
  // Static model migration function registration.
  //
  template <schema_version v, schema_version base>
