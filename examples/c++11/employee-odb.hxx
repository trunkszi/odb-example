...
namespace odb
{
  ...
  class access::object_traits< ::employer >
  {
    ...
    typedef ::std::shared_ptr< ::employer > pointer_type;
  ...
  class access::object_traits< ::employee >
  {
    ...
    typedef ::std::shared_ptr< ::employee > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;
  ...
  //
  template <>
  struct class_traits< ::pension_fund >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::pension_fund >
  {
    public:
    typedef ::pension_fund object_type;
    typedef ::std::unique_ptr< ::pension_fund > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;
...
namespace odb
{
    ...
    public access::object_traits< ::employee >
  {
    ...
    struct emails_traits
    {
      ...
      typedef ::employee::emails_type container_type;
      typedef
      odb::access::container_traits<container_type>
      container_traits_type;
      typedef container_traits_type::value_type value_type;
      ...
      typedef pgsql::container_statements< emails_traits > statements_type;
  ...
  //
  template <typename A>
  struct query_columns< ::pension_fund, id_pgsql, A >
  {
    // name
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::pension_fund, id_pgsql, A >::name_type_
  query_columns< ::pension_fund, id_pgsql, A >::
  name (A::table_name, "\"name\"", 0);

  template <typename A>
  struct pointer_query_columns< ::pension_fund, id_pgsql, A >:
    query_columns< ::pension_fund, id_pgsql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::pension_fund, id_pgsql >:
    public access::object_traits< ::pension_fund >
  {
    public:
    struct id_image_type
    {
    ...
    struct members_traits
    {
      ...
      typedef ::pension_fund::members_type container_type;
      typedef
      odb::access::container_traits<container_type>
      container_traits_type;
      typedef container_traits_type::index_type index_type;
  ...
  template <>
  class access::object_traits_impl< ::pension_fund, id_common >:
    public access::object_traits_impl< ::pension_fund, id_pgsql >
  {
  };
