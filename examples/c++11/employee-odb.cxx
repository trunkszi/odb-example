...
namespace odb
{
  ...
  select_statement[] =
  "SELECT "
  "\"employee_emails\".\"value\" "
  "FROM \"employee_emails\" "
  "WHERE \"employee_emails\".\"object_id\"=$1";
  ...
  select_statement[] =
  "SELECT "
  "\"pension_fund_members\".\"index\", "
  "\"pension_fund_members\".\"value\" "
  "FROM \"pension_fund_members\" "
  "WHERE \"pension_fund_members\".\"object_id\"=$1 ORDER BY \"pension_fund_members\".\"index\"";

  const char access::object_traits_impl< ::pension_fund, id_pgsql >::members_traits::
  insert_statement[] =
  "INSERT INTO \"pension_fund_members\" "
  "(\"object_id\", "
  "\"index\", "
  "\"value\") "
  "VALUES "
  ...
  const char access::object_traits_impl< ::pension_fund, id_pgsql >::members_traits::
  delete_statement[] =
  "DELETE FROM \"pension_fund_members\" "
  "WHERE \"object_id\"=$1";
