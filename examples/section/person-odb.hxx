...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::person, id_pgsql, A >::bio_type_
  query_columns< ::person, id_pgsql, A >::
  bio (A::table_name, "\"bio\"", 0);
    ...
    public access::object_traits< ::person >
  {
    ...
    struct nicknames_traits
    {
      ...
      typedef pgsql::smart_container_statements< nicknames_traits > statements_type;
    ...
    struct extras_traits
    {
      ...
      typedef pgsql::section_statements< object_type, extras_traits > statements_type;
