...
namespace odb
{
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.second_value.data_ptr ();
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.recipient_value.data_ptr ();
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.domain_value.data_ptr ();
  ...
  select_statement[] =
  "SELECT "
  "\"person_name_extras_aliases\".\"index\", "
  "\"person_name_extras_aliases\".\"value_first\", "
  "\"person_name_extras_aliases\".\"value_last\" "
  "FROM \"person_name_extras_aliases\" "
  "WHERE \"person_name_extras_aliases\".\"object_id_recipient\"=$1 AND \"person_name_extras_aliases\".\"object_id_domain\"=$2 ORDER BY \"person_name_extras_aliases\".\"index\"";

  const char access::object_traits_impl< ::person, id_pgsql >::name_extras_aliases_traits::
  insert_statement[] =
  "INSERT INTO \"person_name_extras_aliases\" "
  "(\"object_id_recipient\", "
  "\"object_id_domain\", "
  "\"index\", "
  "\"value_first\", "
  ...
  const char access::object_traits_impl< ::person, id_pgsql >::name_extras_aliases_traits::
  delete_statement[] =
  "DELETE FROM \"person_name_extras_aliases\" "
  ...
  "\"person\".\"name_last\", "
  "\"person\".\"name_title\", "
  "\"person\".\"name_extras_nickname\", "
  "\"person\".\"phone_first\", "
  "\"person\".\"phone_second\" "
  "FROM \"person\" "
  "WHERE \"person\".\"email_recipient\"=$1 AND \"person\".\"email_domain\"=$2";
