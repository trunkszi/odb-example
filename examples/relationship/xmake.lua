...
target("relationship", function()
    on_load(function(target)
        os.cd("$(projectdir)/examples/relationship")
        ...
        elseif is_plat("linux") then
            ...
            os.execv(path.absolute("../../vendor/odb/linux/bin/odb"), { "--std", "c++14", "-d", "pgsql", "-I", path.absolute("../../vendor/odb/linux/include"), "--generate-query", "--generate-prepared", "--generate-schema", "employee.h" })
        elseif is_plat("macosx") then
            ...
            os.execv(path.absolute("../../vendor/odb/macosx/bin/odb"), { "--std", "c++14", "-d", "pgsql", "-I", path.absolute("../../vendor/odb/macosx/include"), "--generate-query", "--generate-prepared", "--generate-schema", "employee.h" })
        end
