...
namespace odb
{
  ...
  template <typename A>
  const typename pointer_query_columns< ::employee, id_pgsql, A >::name_class_::first_type_
  pointer_query_columns< ::employee, id_pgsql, A >::name_class_::
  first (A::table_name, "\"first_name\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::employee, id_pgsql, A >::name_class_::last_type_
  pointer_query_columns< ::employee, id_pgsql, A >::name_class_::
  last (A::table_name, "\"last_name\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::employee, id_pgsql, A >::name_class_
  pointer_query_columns< ::employee, id_pgsql, A >::name;
    ...
    public access::object_traits< ::employee >
  {
    ...
    struct image_type
    {
      ...
      // name_
      //
      composite_value_traits< ::employee::name_type, id_pgsql >::image_type name_value;
    ...
    struct degrees_traits
    {
      ...
      typedef pgsql::container_statements< degrees_traits > statements_type;
  ...
  template <typename A>
  const typename query_columns< ::employee, id_pgsql, A >::name_class_::first_type_
  query_columns< ::employee, id_pgsql, A >::name_class_::
  first (A::table_name, "\"first_name\"", 0);

  template <typename A>
  const typename query_columns< ::employee, id_pgsql, A >::name_class_::last_type_
  query_columns< ::employee, id_pgsql, A >::name_class_::
  last (A::table_name, "\"last_name\"", 0);

  template <typename A>
  const typename query_columns< ::employee, id_pgsql, A >::name_class_
  query_columns< ::employee, id_pgsql, A >::name;
