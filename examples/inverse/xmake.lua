...
target("inverse", function()
    on_load(function(target)
        os.cd("$(projectdir)/examples/inverse")
        ...
        elseif is_plat("macosx") then
            ...
            os.execv(path.absolute("../../vendor/odb/macosx/bin/odb"), { "--std", "c++14", "-d", "pgsql", "-I", path.absolute("../../vendor/odb/macosx/include"), "--generate-query", "--generate-schema", "--generate-prepared", "employee.h" })
        end
