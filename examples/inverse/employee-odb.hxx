...
namespace odb
{
    ...
    public access::object_traits< ::employer >
  {
    ...
    struct employees_traits
    {
      ...
      typedef pgsql::container_statements< employees_traits > statements_type;
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::position, id_pgsql, A >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename pointer_query_columns< ::position, id_pgsql, A >::id_type_
  pointer_query_columns< ::position, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::position, id_pgsql, A >::title_type_
  pointer_query_columns< ::position, id_pgsql, A >::
  title (A::table_name, "\"title\"", 0);

  template <>
  class access::object_traits_impl< ::position, id_pgsql >:
  ...
  class access::object_traits_impl< ::position, id_common >:
    public access::object_traits_impl< ::position, id_pgsql >
  {
  };
  ...
  template <typename A>
  const typename pointer_query_columns< ::employee, id_pgsql, A >::position_type_
  pointer_query_columns< ::employee, id_pgsql, A >::
  ...
  template <>
  struct query_columns_base< ::position, id_pgsql >
  {
    // employee
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::position, id_pgsql, A >:
    query_columns_base< ::position, id_pgsql >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::position, id_pgsql, A >::id_type_
  query_columns< ::position, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::position, id_pgsql, A >::title_type_
  query_columns< ::position, id_pgsql, A >::
  title (A::table_name, "\"title\"", 0);
  ...
  template <typename A>
  const typename query_columns< ::employee, id_pgsql, A >::position_type_
  query_columns< ::employee, id_pgsql, A >::
  position (A::table_name, "\"position\"", 0);
}
