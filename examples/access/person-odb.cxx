...
namespace odb
{
        ...
        bool* t)
  {
    ...
    if (t[2UL])
    {
      i.middle_value.capacity (i.middle_size);
      grew = true;
    }
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.middle_value.data_ptr ();
    b[n].capacity = i.middle_value.capacity ();
    b[n].size = &i.middle_size;
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    {
      // From person.h:109:14
      ::std::string const& v =
        o.g_middle ();

      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.middle_value.capacity ());
      pgsql::value_traits<
          ::std::string,
          pgsql::id_string >::set_image (
        i.middle_value,
      ...
      i.middle_size = size;
      grew = grew || (cap != i.middle_value.capacity ());
    }

    // last_
    //
    {
      // From person.h:112:14
      ::std::string const& v =
        std::string (o.last ());
