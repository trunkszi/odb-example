...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::person, id_pgsql, A >::email_type_
  ...
  template <typename A>
  const typename query_columns< ::person, id_pgsql, A >::middle_type_
  query_columns< ::person, id_pgsql, A >::
  middle (A::table_name, "\"middle\"", 0);
