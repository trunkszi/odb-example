...
namespace odb
{
  ...
  const char access::view_traits_impl< ::person_count, id_pgsql >::
  query_statement_name[] = "query_person_count";

  bool access::view_traits_impl< ::person_count, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::person_count, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i)
  {
    using namespace pgsql;
  ...
  access::view_traits_impl< ::person_count, id_pgsql >::query_base_type
  access::view_traits_impl< ::person_count, id_pgsql >::
  ...
  result< access::view_traits_impl< ::person_count, id_pgsql >::view_type >
  access::view_traits_impl< ::person_count, id_pgsql >::
  query (database& db, const query_base_type& q)
  {
    using namespace pgsql;
